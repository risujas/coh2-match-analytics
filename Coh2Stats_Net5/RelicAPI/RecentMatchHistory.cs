...
namespace Coh2Stats.RelicAPI
{
	public class RecentMatchHistory
	{
		...
		public static Root RequestByProfileId(int profileId)
		{
			string requestUrl = "https://coh2-api.reliclink.com/community/leaderboard/getRecentMatchHistoryByProfileId";
			string requestParams = "?title=coh2&profile_id=" + profileId;
